...
GO
:setvar DatabaseName "Hisab5"
:setvar DefaultFilePrefix "Hisab5"
...
CREATE TABLE [dbo].[EventFriend] (
    [EventFriendId] INT           IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_EventFriend] PRIMARY KEY CLUSTERED ([EventFriendId] ASC)
);
